...
export const sendVerificationEmail = createAsyncThunk(
  ...
  async (user, thunkAPI) => {
    try {
      return await authService.sendVerificationEmail(user);
    } catch (error) {
      const message =
        (error.response &&
          error.response.data &&
...
export const saveApiKey = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    try {
      return await authService.saveApiKey(data);
    } catch (error) {
      const message =
        (error.response &&
          error.response.data &&
...
export const saveModel = createAsyncThunk(
  ...
  async (data, thunkAPI) => {
    try {
      return await authService.saveModel(data);
    } catch (error) {
      const message =
        (error.response &&
          error.response.data &&
...
export const selectIsLoggedIn = async (state) => state.auth.isLoggedIn
